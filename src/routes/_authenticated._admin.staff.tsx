  ...
  const createM = useMutation({
    ...
    onSuccess: (res) => {
      toast.success(`Account created. Temporary password: ${res.tempPassword}`, {
        description:
          "Copy it now — it is shown only once. Share it securely and have them change it after signing in.",
        duration: Infinity,
        closeButton: true,
      });
    ...
    <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Create faculty and placement officer accounts, assign classrooms, and manage refresh
          locks.
        </p>
      </div>
        ...
        >
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div>
              ...
              <Select
                value={role}
                onValueChange={(v: "faculty" | "placement_officer") => setRole(v)}
              >
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          invalidates their current one. It will be shown to you once — copy it and
                          share it securely.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          assignments. It cannot be undone. You cannot delete your own account or
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              If a refresh job is stuck (e.g. the worker crashed), you can force-release the global
              lock here.
            </p>
          </div>
          <Button
