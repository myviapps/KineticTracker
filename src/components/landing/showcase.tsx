        ...
        <div className="lp-panel-surface overflow-hidden rounded-xl">
          ...
          <div className="grid gap-px bg-border lg:grid-cols-[1fr_20rem]">
            ...
            <div className="bg-background p-5">
              ...
              <ul className="mt-3 flex flex-col gap-2.5">
                {ACCOUNTS.map((a) => (
                  <li key={a.platform} className="flex items-center gap-3">
                    <span className="w-28 shrink-0 truncate font-mono text-2xs uppercase tracking-wider text-muted-foreground">
                      {a.platform}
                    </span>
              ...
              <div className="mt-6 font-mono text-3xs font-bold uppercase tracking-widest text-muted-foreground">
                Difficulty split
              </div>
