  ...
  (
        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            className={cn(
              ...
              fromEdge ? "max-h-[85svh] w-full overflow-y-auto" : "w-(--sidebar-width)",
            )}
            style={
              {
          ...
          >
            ...
            <div className={cn("flex w-full flex-col", !fromEdge && "h-full")}>{children}</div>
          </SheetContent>
        </Sheet>
      );
    }
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) bg-transparent transition-[width] duration-(--duration-panel) ease-glide",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-(--duration-panel) ease-glide md:flex",
            side === "left"
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-[transform,background-color] ease-glide after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] after:transition-colors hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity] duration-(--duration-panel) ease-glide focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
