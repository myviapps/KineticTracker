...
// Not from './types': that file is regenerated by `npm run gen-types`, which
// deletes anything hand-added to it.
 ...
 */
export const requireAdmin = createMiddleware({ type: "function" }).server((async ({
  next,
  context,
}: {
